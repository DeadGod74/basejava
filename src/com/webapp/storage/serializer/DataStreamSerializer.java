...
public class DataStreamSerializer implements Serialization {
                ...
                switch (type) {
                    ...
                    case EDUCATION:
                        writeCollection(dos, ((CompanySection) section).getCompanies(), com -> {
                            dos.writeUTF(com.getNameCompany());
                            dos.writeUTF(com.getWebsite());
    ...
    public Resume doRead(InputStream is) throws IOException {
        try (DataInputStream dis = new DataInputStream(is)) {
            ...
            readItems(dis, () -> {
                TypeSection sectionType = TypeSection.valueOf(dis.readUTF());
    ...
    private Section readSection(DataInputStream dis, TypeSection sectionType) throws IOException {
        switch (sectionType) {
            case PERSONAL:
            case OBJECTIVE:
            ...
            case EDUCATION:
                return new CompanySection(
                        readList(dis, () -> {
                            ...
                            List<Period> periods = readList(dis, () -> new Period(
                                    readLocalDate(dis),
                                    readLocalDate(dis),
                                    dis.readUTF(),
                                    dis.readUTF()
